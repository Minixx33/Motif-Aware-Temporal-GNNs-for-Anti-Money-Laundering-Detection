...
# =============================================================================
# RAT HIGH INTENSITY EXPERIMENTS
# Runs: GraphSAGE, GraphSAGE-T, TGAT with high RAT intensity
# =============================================================================
...
echo "===============================================================" | tee -a "$LOG_FILE"
echo " Running RAT HIGH Intensity Experiments " | tee -a "$LOG_FILE"
...
run_model() {
    ...
    echo "" | tee -a "$LOG_FILE"
    echo "[ $(date +"%Y-%m-%d %H:%M:%S") ] >>> Running $MODEL_NAME (RAT HIGH)..." | tee -a "$LOG_FILE"
...
echo "" | tee -a "$LOG_FILE"
echo "===============================================================" | tee -a "$LOG_FILE"
echo " ALL RAT HIGH EXPERIMENTS COMPLETED SUCCESSFULLY " | tee -a "$LOG_FILE"
echo " Total time: ${total_h}h ${total_m}m ${total_s}s ($total_time seconds) " | tee -a "$LOG_FILE"
echo " Log saved to: $LOG_FILE " | tee -a "$LOG_FILE"
echo "===============================================================" | tee -a "$LOG_FILE"

# Create completion marker
touch "$LOG_DIR/RAT_HIGH_FINISHED_${ts}.done"

echo ""
echo "SUCCESS! All RAT HIGH experiments completed."
