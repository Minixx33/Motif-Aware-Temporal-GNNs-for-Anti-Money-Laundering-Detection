...
# ---------------------------------------------------------
# Detect the conda install in this order:
#   1. CONDA_EXE env var (set automatically by `conda init`)
#   2. `conda` on PATH
#   3. Common install locations on Linux / macOS / Windows-GitBash
# Override the env name with: CONDA_ENV=my_env bash run_baseline.sh
CONDA_BASE=""
