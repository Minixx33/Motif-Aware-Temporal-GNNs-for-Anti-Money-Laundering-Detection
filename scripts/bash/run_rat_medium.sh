...
echo "===============================================================" | tee -a "$LOG_FILE"
echo " Running RAT MEDIUM Experiments " | tee -a "$LOG_FILE"
...
run_model() {
    ...
    echo "" | tee -a "$LOG_FILE"
    echo ">>> Running $NAME (RAT MEDIUM)..." | tee -a "$LOG_FILE"
...
touch "$LOG_DIR/RAT_MEDIUM_DONE_${ts}.done"
echo "SUCCESS (RAT MEDIUM)"
