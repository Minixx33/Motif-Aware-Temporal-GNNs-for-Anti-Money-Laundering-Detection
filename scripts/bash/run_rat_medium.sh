...
# =============================================================================
# RAT MEDIUM INTENSITY EXPERIMENTS
# Runs: GraphSAGE, GraphSAGE-T, TGAT with medium RAT intensity
# =============================================================================
...
LOG_DIR="logs"
mkdir -p "$LOG_DIR"
LOG_FILE="$LOG_DIR/rat_medium_${ts}.log"

echo "===============================================================" | tee -a "$LOG_FILE"
echo " Running RAT MEDIUM Intensity Experiments " | tee -a "$LOG_FILE"
...
run_model() {
    ...
    echo "" | tee -a "$LOG_FILE"
    echo "[ $(date +"%Y-%m-%d %H:%M:%S") ] >>> Running $MODEL_NAME (RAT MEDIUM)..." | tee -a "$LOG_FILE"
...
echo "" | tee -a "$LOG_FILE"
echo "===============================================================" | tee -a "$LOG_FILE"
echo " ALL RAT MEDIUM EXPERIMENTS COMPLETED SUCCESSFULLY " | tee -a "$LOG_FILE"
echo " Total time: ${total_h}h ${total_m}m ${total_s}s ($total_time seconds) " | tee -a "$LOG_FILE"
echo " Log saved to: $LOG_FILE " | tee -a "$LOG_FILE"
echo "===============================================================" | tee -a "$LOG_FILE"

# Create completion marker
touch "$LOG_DIR/RAT_MEDIUM_FINISHED_${ts}.done"

echo ""
echo "SUCCESS! All RAT MEDIUM experiments completed."
